...
get_eurostat_trade_data <- function(
    ...
    if (is.null(partner)) {
        ...
        partner <- c(
            ...
            "CA","CC","CD","CF","CG","CH","CI","CK","CL","CM","CN","CO","CR","CS","CU","CV","CW","CX","CY","CZ","DD","DE","DJ","DK","DM","DO","DZ",
            "EA19_EXTRA","EA19_INTRA","EA20_EXTRA","EA20_INTRA","EC","EE","EG","EH","ER","ES","ET",
            "EU27_2020_EXTRA","EU27_2020_INTRA","EUROZONE_EXTRA","EUROZONE_INTRA","EU_EXTRA","EU_INTRA",
            "FI","FJ","FK","FM","FO","FR","GA","GB","GD","GE","GF","GH","GI","GL","GM","GN","GP","GQ","GR","GS","GT","GU","GW","GY",
            "HK","HM","HN","HR","HT","HU","ID","IE","IL","IN","IO","IQ","IR","IS","IT",
            "JM","JO","JP","KE","KG","KH","KI","KM","KN","KP","KR","KW","KY","KZ","LA","LB","LC","LI","LK","LR","LS","LT","LU","LV","LY",
            "MA","MD","ME","MG","MH","MK","ML","MM","MN","MO","MP","MQ","MR","MS","MT","MU","MV","MW","MX","MY","MZ",
            "NA","NC","NE","NF","NG","NI","NL","NO","NP","NR","NU","NZ",
            "OM","PA","PE","PF","PG","PH","PK","PL","PM","PN","PS","PT","PW","PY",
            "QA","QP","QQ","QR","QS","QU","QV","QW","QX","QY","QZ",
            "RE","RO","RU","RW",
            ...
            "WF","WORLD","WS",
            "XA","XB","XC","XI","XK","XL","XM","XO","XP","XR","XS","XU","XZ",
            "YD","YE","YT","YU","ZA","ZM","ZW"
        )
    }
